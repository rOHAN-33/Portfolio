  ...
  return (
    <div
      className={cn(
        ...
        isSpacer ? " bg-slate-900/30" : "shadow-sm ring-1 ring-black/5",
        tile.className,
      )}
      ...
      <div className="bg-dots">
        <section className="mx-auto max-w-6xl px-4 py-8 md:py-12">
          <header className="mb-6 md:mb-8">
            <h1 className="text-pretty text-2xl font-semibold md:text-7xl text-center " style={{ fontFamily: 'Antonio, sans-serif' }}
            >Tech stack</h1>
